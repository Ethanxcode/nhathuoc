...
class CustomerPointController extends AppBaseController
{
    ...
    public function create()
    {
        $customers = Users::all()->pluck('name', 'id')->toArray();
        $products = Product::all()->pluck('product_name', 'id')->toArray();
        return view('backend.customer_points.create', compact('customers','products'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.customer_points.show')->with('customerPoint', $customerPoint);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.customer_points.edit',compact('products','customers','customerPoint'));
    }
