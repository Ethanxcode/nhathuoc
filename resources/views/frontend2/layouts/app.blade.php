...
<head>
    ...
    <link href="{{ asset('web/css/@fortawesome/fontawesome-free/css/all.css') }}" rel="stylesheet" type="text/css">
    ...
    <link href="{{ asset('web/css/jquery.mCustomScrollbar.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" href="{{ asset('web/css/custom2.css') }}">
