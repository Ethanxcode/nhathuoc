...
mix
  .js("public/js/scripts.js", "public/js/scripts.min.js")
...
mix
  .js(
    "resources/assets/js/resources/resources.js",
    "public/assets/js/resources/resources.js"
  )
  .version();
...
mix
  .js(
    ...
    "public/assets/js/admins/admins.js"
  )
  .version();

mix
  .js("resources/assets/js/pages/pages.js", "public/assets/js/pages/pages.js")
  .version();
...
mix
  .js(
    "resources/assets/js/qrcodes/qrcodes.js",
    "public/assets/js/qrcodes/qrcodes.js"
  )
  .version();

mix
  .js(
    "resources/assets/js/gift_types/gift_types.js",
    "public/assets/js/gift_types/gift_types.js"
  )
  .version();

mix
  .js("resources/assets/js/gifts/gifts.js", "public/assets/js/gifts/gifts.js")
  .version();

mix
  .js(
    "resources/assets/js/customer_gifts/customer_gifts.js",
    "public/assets/js/customer_gifts/customer_gifts.js"
  )
  .version();

mix
  .js(
    "resources/assets/js/customer_points/customer_points.js",
    "public/assets/js/customer_points/customer_points.js"
  )
  .version();


 mix.js('resources/assets/js/customer_client_point/customer_client_point.js', 'public/assets/js/customer_client_point/customer_client_point.js').version();


 mix.js('resources/assets/js/nhathuoc/nhathuoc.js', 'public/assets/js/nhathuoc/nhathuoc.js').version();
